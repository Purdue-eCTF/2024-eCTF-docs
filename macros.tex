...
\newcommand{\carid}{\ensuremath{\mathsf{CID}}\xspace}
\newcommand{\featid}{\ensuremath{\mathsf{FID}}\xspace}
% pkgs _CarID[#1]
\newcommand{\pkgs}[1]{\ensuremath{\mathsf{pkgs}_{#1}}\xspace}
\newcommand{\enckey}{\ensuremath{K}\xspace}
% pkg _CarID[#1] ^(FeatureNum[#2])
\newcommand{\pkg}[2]{\ensuremath{\mathsf{pkg}_{#1}^{(#2)}}\xspace}
% fpwd _ CarID[#1] ^(FeatureNum[#2])
\newcommand{\featpwd}[2]{\ensuremath{\mathsf{fpwd}_{#1}^{(#2)}}\xspace}
% F _CarID[#1]
\newcommand{\featlist}[1]{\ensuremath{F_{#1}}\xspace}
...
% Substack with alignment point for subscript https://tex.stackexchange.com/questions/198771/align-in-substack
\makeatletter
...
\newcommand{\fracinv}[1]{\ensuremath{\frac1{#1}}\xspace}
...
\newcommand{\yieldsto}[1][*]{\ensuremath{\overset{#1}{\rightarrow}_M}\xspace}
